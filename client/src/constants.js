  ...
  SPEECH: {
    CREATE: {
      ERROR: {
        ...
        3: 'shhh! Whatever! See if I care.',
        4: 'Oh My - CIRCUITS! and My OCD',
        5: 'Humph. Your motherboard. Eat my circuits, dumb meatbag.',
      },
      ALT: {
        ...
        5: "Oh my circuits -...I'm still saying stuff out loud. I'm gonna have to talk to my developer about that!",
      },
      NORMAL: {
    ...
    BONUS: {
      SASS: [
        "Welcome to Maid-Bot Home Defense Systems. Give my robot a name - hm - I mean, give 'your' robot a name and choose it's type...- that is, the number of legs it has. Then submit.",
